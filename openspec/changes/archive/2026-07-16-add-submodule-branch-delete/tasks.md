...
- [x] 5.3 Record the decision to descope precise pre-/post-topology delta verification for concurrent `.gitmodules` edits.
...
- [x] 5.4 Record the decision to descope full multi-snapshot revalidation immediately before finalization and commit.
