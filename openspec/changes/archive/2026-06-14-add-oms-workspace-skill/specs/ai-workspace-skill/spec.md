...
- **AND** `npx skills add divlook/oh-my-space --skill oms-workspace` installs only the broad-trigger skill
...
- **THEN** the command prints `npx skills add divlook/oh-my-space` as the project-scope command to install the `oms` workspace skills
- **AND** prints `npx skills add divlook/oh-my-space -g` as the global install command
...
- **AND** delegates to `npx skills add divlook/oh-my-space`
...
- **THEN** the extra arguments are forwarded verbatim to `npx skills add divlook/oh-my-space`
...
- **AND** points to `npx skills add divlook/oh-my-space -g` for a global install
