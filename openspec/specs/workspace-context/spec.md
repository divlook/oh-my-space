...
Define how commands discover the nearest workspace, infer configured submodule context, and verify that submodule operations target the workspace root Git repository.
